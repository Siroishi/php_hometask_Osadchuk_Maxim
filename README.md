...
5. Тепер усі наступні домашні завдання ви повинні виконувати в вашому проекті `php_hometask_Pyatochkin_Petro`
6. Кожне окреме завдання комітити з приміткою `HomeTask #1`, `HomeTask #2` і т.д.
